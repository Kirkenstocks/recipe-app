...
ALLOWED_HOSTS = ['127.0.0.1', 'localhost', 'https://recipe-app-oi7b.onrender.com']
...
# DATABASES = {
#     'default': dj_database_url.config(default=str(os.getenv('DATABASE_CONNECTION_STRING')), conn_max_age=600)
# }   
